                ...
                </ul>
                {
                  paymentMethod === 'card' && (
                    <>
                      ...
                      <div className="card__left">
                        ...
                        <div className="card__body">
                          <div className="card__body-row">
                            ...
                            <div className="card__body-numbers">
                              <input type="text" className="card__input" ref={cardNumber} placeholder="0000"/>
                              <input type="text" className="card__input" placeholder="0000"/>
                              <input type="text" className="card__input" placeholder="0000"/>
                              <input type="text" className="card__input" placeholder="0000"/>
                            </div>
                          </div>
                          <div className="card__body-row">
                            <label className="card__body-label">Срок действия</label>
                      ...
                      <p style={{ marginTop: 0, color: 'grey', textAlign: 'center' }}>Нажимая кнопку, вы принимаете <a href="!#">условие сервиса</a></p>
          ...
          <>
            <div className="basket">
              ...
              <div className="basket__header">
                <h2 className="basket__header-title">Детали заказа №32523</h2>
              </div>
              ...
              <table>
                    ...
                    <tr>
                      <th colspan="4" style={{ textAlign: 'end' }}>Итог: {Number('1000').toLocaleString()} ₽</th>
                    </tr>
                </table>
              </div>
              <div className="basket__footer">
                <button className="basket__footer-btn edit">Изменить</button>
                <button className="basket__footer-btn close" onClick={handleCloseBasket}>Отмена</button>
              </div>
            </div>
